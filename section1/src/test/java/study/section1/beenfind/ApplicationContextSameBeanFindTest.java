package study.section1.beenfind;
...
public class ApplicationContextSameBeanFindTest {
    ...
    @Test
    @DisplayName("타입으로 조회시 같은 타입이 둘 이상 있는 경우 중복 오류 발생")
    ...
    void findAllBeanByType(){
        Map<String, MemberRepository> beanType = ac.getBeansOfType(MemberRepository.class);
